...
export class AddGoogleIdAndLoginTimestamps1782109010844 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_fabacc1cb5e35d51e5fe4c3f6c4" UNIQUE ("googleid")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_fabacc1cb5e35d51e5fe4c3f6c4"`);
